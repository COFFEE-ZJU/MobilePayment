		...
		btnModify.setOnClickListener(
				new OnClickListener() {
					...
					public void onClick(View v) {
						postModify();
						Toast.makeText(ModifyInforActivity.this, "修改成功", Toast.LENGTH_SHORT).show();
						Intent personalIntent = new Intent(ModifyInforActivity.this, PersonalInforActivity.class);
