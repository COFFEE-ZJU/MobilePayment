...
public class ModifyPasswordActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		confirmedModifiedPasswordEditText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
			@Override
			public boolean onEditorAction(TextView textView, int id,
					KeyEvent keyEvent) {
				if (id == R.id.EditText_confirmed_modified_password || id == EditorInfo.IME_NULL) {
					postModifiedPassword();
					Toast.makeText(ModifyPasswordActivity.this, "修改密码完成", Toast.LENGTH_SHORT).show();
					Intent personalIntent = new Intent(ModifyPasswordActivity.this, PersonalInforActivity.class);
	...
	protected boolean postModifiedPassword() {
		...
		String confirmedModifiedPassword = confirmedModifiedPasswordEditText.getText().toString();
		String[]  keys = {"current_password", "modified_password", "confirmed_modified_password"};
		String[] values = {currentPassword, modifiedPassword, confirmedModifiedPassword};
