...
public class PersonalInforActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SimpleAdapter listItemAdapter = new SimpleAdapter(this, getData(),
				R.layout.key_value_item,
				new String[] {"key", "value"},
				new int[]{
			R.id.key_item, R.id.value_item});
		...
		btnModifyInfor.setOnClickListener( new Button.OnClickListener(){
			public void onClick(View v){
				Intent modifyInforIntent = new Intent(PersonalInforActivity.this, ModifyInforActivity.class);
		...
		btnModifyPasswordButton.setOnClickListener(new Button.OnClickListener(){
			public void onClick(View v){
				Intent modifyPasswordIntent = new Intent(PersonalInforActivity.this, ModifyPasswordActivity.class);
		...
		btnChargeButton.setOnClickListener(new Button.OnClickListener(){
			public void onClick(View v){
				Intent chargeIntent = new Intent(PersonalInforActivity.this, ChargeActivity.class);
		...
		btnBack.setOnClickListener(new Button.OnClickListener(){
			public void onClick(View v){
				Intent mainIntent = new Intent(PersonalInforActivity.this, MainActivity.class);
		...
		btnStatement.setOnClickListener(new Button.OnClickListener(){
			public void onClick(View v){
				Intent statementIntent = new Intent(PersonalInforActivity.this, StatementActivity.class);
