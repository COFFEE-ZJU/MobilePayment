...
public class RegisterActivity extends Activity {
	...
	protected boolean postRegister(){
		...
		String[] keys = {"user_name", "real_name", "password", "confirmed_password", "address", "mobile_phone", "ID", "Email", "gender"};
		String[] values = {UserName, RealName, Password, ConfirmedPassword, Address, MobilePhone, ID, Email, Gender};
