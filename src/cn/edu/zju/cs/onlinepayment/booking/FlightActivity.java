	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		date.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				new DatePickerDialog(FlightActivity.this,
		...
		search_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// 测试的数据
				String[] com = new String[] { "国航", "华泰", "泛美", "联合", "国航",
						"华泰", "泛美", "联合" };
				String[] flightNo = new String[] { "gh1320", "ht1239",
						"fm9094", "lh8493", "gh93029", "ht89894", "lh10203",
						"lh10203" };
				String[] leavetime = new String[] { "12:30", "1:30", "2:30",
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
						...
						comfirm.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View arg0) {
								...
								intent.setClass(FlightActivity.this,
